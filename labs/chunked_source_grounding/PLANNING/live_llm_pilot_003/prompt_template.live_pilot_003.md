# Chunked Source Grounding Live Pilot 003 Prompt Template

Status: Goal 8B prompt template
...
Your task is to read one approved trader-education source excerpt as chunked text, preserve source support explicitly, and produce proposal-only research output focused on source-span precision.
...
Method: `chunked_source_grounding_live_pilot_003_method`
