# Chunked Source Grounding Live Pilot 006 Prompt Template

Status: Goal 12B prompt template
...
Your task is to read one approved second source excerpt as chunked text, preserve source support explicitly, and produce proposal-only research output focused on line-range locator candidates.
...
Method: `chunked_source_grounding_live_pilot_006_method`
